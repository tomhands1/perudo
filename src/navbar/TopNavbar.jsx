                ...
                <div>
                    ...
                    >
                        ...
                        {props.auth.uid ? (
                            ...
                            <div>
                                <MenuItem onClick={() => redirect('/sign-in')}>Sign in</MenuItem>
                                <MenuItem onClick={() => redirect('/sign-up')}>Sign up</MenuItem>
                                <MenuItem onClick={() => redirect('password-reset')}>Forgot password?</MenuItem>
                            </div>
                        )}
                    </Menu>
                </div>
